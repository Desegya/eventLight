  ...
  return (
    <Flex minH="100vh">
      ...
      >
        ...
        {/* Back to home — prominent, top of nav */}
        <Box px={4} pt={4} pb={2}>
          <Link to="/">
            <HStack
              spacing={2.5}
              ...
              fontSize="sm"
              fontWeight="600"
              _hover={{ bg: navHoverBg, color: navActiveColor, borderColor: "brand.200" }}
              transition="all 0.15s ease"
              cursor="pointer"
            >
              <Icon as={FiCompass} boxSize={4} />
              <Text>Discover Events</Text>
            </HStack>
          </Link>
        </Box>

        <Divider borderColor={borderColor} mx={4} w="auto" />

        {/* User mini-card */}
        <Box px={5} py={4}>
          <HStack spacing={3}>
            <Avatar name={displayName} size="sm" bg="brand.600" color="white" fontSize="xs" fontWeight="700" />
            <Box minW={0}>
        ...
        {/* Nav items */}
        <VStack align="stretch" spacing={0.5} px={3} pb={4} flex={1}>
        ...
        <Box px={3} py={4} borderTop="1px solid" borderColor={borderColor}>
          <HStack
            spacing={3} px={3} py={2.5} borderRadius="xl" cursor="pointer"
      ...
      <Box flex={1} bg={contentBg} minH="100vh" overflowY="auto">
        ...
        >
          ...
          <HStack spacing={2}>
            <Text fontSize="sm" fontWeight="600" color={wordmarkColor}>
              {displayName}
            </Text>
        ...
        {/* Page content */}
        <Box maxW="860px" mx="auto" px={{ base: 4, md: 8 }} py={{ base: 6, md: 10 }}>
          <Outlet />
        </Box>
      </Box>
    </Flex>
